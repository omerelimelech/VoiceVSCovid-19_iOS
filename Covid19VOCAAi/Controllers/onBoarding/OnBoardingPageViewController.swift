...
class OnBoardingPageViewController: UIPageViewController, UIPageViewControllerDataSource {
    ...
    static func initialization() -> OnBoardingPageViewController {
        return UIStoryboard.init(name: "onboarding", bundle: nil).instantiateInitialViewController() as! OnBoardingPageViewController
    }
    ...
    func setupControllers(){
        ...
        let ob4 = sb.instantiateViewController(withIdentifier: "ob4") as! OnBoardingDoneViewController
        ob4.delegate = self
        self.controllers = [ob1,ob2,ob3,ob4]
    }
