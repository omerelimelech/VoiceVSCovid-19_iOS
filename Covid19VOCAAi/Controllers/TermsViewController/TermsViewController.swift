...
class TermsViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.beneditsAndRisksTextView.text = "We hope to be able to assist in early and remote diagnosis of respiratory disease, to target suspected cases for expensive laboratory tests.\nWe have not identified any particular risk associated with your participation in this venture. ".localized()
